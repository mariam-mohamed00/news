...
class ApiManager {
  static Future<SourceResponse> getSources(String categoryId, String locale) async {
    // https://newsapi.org/v2/top-headlines/sources?apiKey=API_KEY
    Uri url = Uri.https(ApiConstant.baseUrl, ApiConstant.sourceApi,
        {'apiKey': '9c1f5339332a42c6a972b8d0dfae0615', 'category': categoryId,'language': locale});
    try {
  ...
  static Future<NewsResponse> getNewsBySourceId({required String sourceId, int pageNumber = 1}) async {
